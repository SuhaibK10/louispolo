...
// Lands here only after /api/checkout/verify has confirmed the payment
// signature server-side. Fetches the order back from Supabase to display
// real details rather than just a generic "thanks" message — this also
// doubles as an implicit re-confirmation that the order actually exists

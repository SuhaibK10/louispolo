...
const POSITIONS: OpenPosition[] = [
  {
    ...
    description:
      "Own the look and feel of everything Louis Polo customers touch, the website, the app, every PDP and campaign page. High design quotient is non-negotiable, you notice the details most people scroll past.",
    ...
    whatYoullDo: [
      ...
      'Own new product pages, landing pages, and campaign creatives end to end',
      'Build and maintain a cohesive design system, typography, color, components',
      'Push back on generic, templated design, every screen should look considered',
    ],
    whatWereLookingFor: [
      'A portfolio with real range: layout, typography, color, motion',
      'Obsessive attention to detail, the kind that notices a 2px misalignment',
      'End-to-end fluency in Figma, from wireframes to dev-ready files',
  ...
  },
  {
    ...
    description:
      "Own creative that doesn't just look beautiful, it sells, hero visuals, Meta ad creatives, product videos and campaign ideas for a growing premium travel brand.",
    ...
    whatWereLookingFor: [
      ...
      'Exceptional prompt writing, comfortable with Midjourney, Nano Banana Pro, FLUX or similar',
